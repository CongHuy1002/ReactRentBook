...
export function CustomerCard() {
    const customerInfo = [
        {
            imgPath: CH,
            comment: 'Đây là cửa hàng sách tốt nhất! Giá cả rất tốt và luôn có một đợt giảm giá nào đó đang diễn ra.',
            name: 'Công Huy / Hồ Chí Minh'
        },
                {
            imgPath: QM,
            comment: 'Tôi rất vui khi tìm được một trang web nơi tôi có thể mua sắm những món đồ đặc biệt.',
            name: 'Quang Minh / Hồ Chí Minh'
        },
                        {
            imgPath: DT,
            comment: 'Đây là một website có dịch vụ thuê sách rất tốt, giá cả hợp lý !',
                        ...
                        <>
                            <div className="col-lg-4">
                                <div className="d-flex flex-column align-items-center customer-card p-3">
                                    <img className='customer-card_img' src={ customer.imgPath } alt="" />
